...
Core PDI model uses the correlation matrix and PCA to create a timeseries of the
variance explained by the principal eignenvector.
...
class pdi(object):
    ...
    def plotly_pdi(self, pcr=None, cum=None, cor=None,
                   animations=True, output=False):
        """
